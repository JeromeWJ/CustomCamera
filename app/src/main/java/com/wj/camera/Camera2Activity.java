...
/**
 * Camera2使用activity写法，未解决的问题的是不能使用前置摄像头拍照
 */
...
public class Camera2Activity extends Activity
    ...
    private final TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture texture, int width, int height) {
            openCamera(width, height, mCameraFacing);
        }
...
//                        captureStillPicture();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera2_custom);
        ...
        mFile = CameraUtil.getInstance().getPhotoFilesDir(this);
    }
    ...
    public void onResume() {
        ...
        if (mTextureView.isAvailable()) {
            openCamera(mTextureView.getWidth(), mTextureView.getHeight(), mCameraFacing);
        } else {
    ...
    private void setUpCameraOutputs(int width, int height, int facing) {
...
//            }
     ...
     * @param path
     */
    private void setPhotoResult(String path) {
    ...
    private void openOrCloseFlash(boolean onOrOff) {//开启闪光灯
        isFlashOn = !onOrOff;
...
//                        //打开或关闭手电筒
//                        mCameraManager.setTorchMode(id, isFlashOn);
//                    }
//                }
//            } catch (CameraAccessException e) {
//                e.printStackTrace();
//            }
            ...
            if (isFlashOn) {
                // 打开闪光灯
                cameraParameters.setFlashMode(Camera.Parameters.FLASH_MODE_TORCH);//开启
                camera.setParameters(cameraParameters);
            } else {
                // 关闭闪光灯
                cameraParameters.setFlashMode(Camera.Parameters.FLASH_MODE_OFF);//关闭
                camera.setParameters(cameraParameters);
            }
        }
    }
    ...
    private void switchCamera() {
        ...
        } else if (mCameraFacing == CameraCharacteristics.LENS_FACING_FRONT) {
            mIbCameraFlash.setVisibility(View.GONE);
            closeCamera();
